...
namespace LargeBank_ORM.Classes
{
    class JeffToolBox
    {
        ...
        public static decimal ReadDecimalZipCode(string message, bool positiveNumber = false, bool acceptZero = true)
        {
            //Reads a 5 digit ZipCode... Recieved from String Input
            while (true)
            {
                try
                {
                    ...
                    if(input.Length > 5)
                    {
                        Console.WriteLine("Please enter a proper 5-Digit zipcode");
                        continue;
                    }
        ...
        public static string getClientState(string message, bool CharAbrevations = true)
        {
            while (true)
            {
                try
                {
                    ...
                    if (CharAbrevations == true)
                    {
                        if (input.Length > 2)
                        {
                            Console.WriteLine("Please enter a state Abrevation using 2 Characters... IE: CA  TX  MD");
                            continue;
                        }
                    }
                ...
                {
                    Console.WriteLine("Please enter your state in the proper format.");
